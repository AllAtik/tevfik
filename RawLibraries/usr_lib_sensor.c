...
void UL_UltrasonicSensorPeripheral(S_ULTRASONIC_SENSOR_PARAMETERS *f_pSensor, EUltrasonicControl f_eControl)
{
    m_sUltrasonicParameter = *f_pSensor;
...
// Timeout girilmesi gerekiyor
int UL_UltrasonicSensorGetValue(uint32_t timeout_ms)
{
