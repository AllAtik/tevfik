...
#endif
*/
#define _gsm_receive_buffer_size         512//512//1024//2048 /// for three buffer * 3
#define _gsm_trasbuffer_buffer_size      512//512//1024 

#define _gsm_mqtt_max_topic_size         128//64//128
#define _gsm_mqtt_max_payoad_size        1024//512//1024//2048

// new
#define _gsm_subcribe_buffer             256 // esas değer 1024
#define _gsm_mqtt_general_func_buffer    2048 // esas değer 1024 ve 2048
...
bool UL_GsmModuleGetResponse(const uint8_t *f_pcCommand, uint16_t f_len, const char *f_pcResponse, uint8_t f_tryCount, uint32_t f_timeout); // satır 579
